...
На слици 7 приказан је _pixelbot_ напад.

![](./pixelbot.gif)

_Слика 7. Pixelbot напад на игру Counter-Strike: Global Offensive. Сваком играчу је додељен гранични оквир и тим којем играч припада (`t` је тим терориста)._

#### Анализа напада

У овом нападу се користи екстерни програм који чита приказ са клијентске апликације у виду матрице пиксела.
Техникама рачунарске визије из тих пиксела издвајају потенцијални играчи.
...
прве две технике митигације из претходне секције (провера интегритета и кернел драјвери). 

Главне тачке напада у овом случају су добављање пиксела из прозора клијента и
слање покрета миша ка клијенту. Добављање пиксела би се могло детектовати
пресретањем графичких драјвера. Слање покрета миша другом процесу би се
потенцијално могло детектовати на нивоу кернела. Међутим, ниједан од ова
приступа није практичан; а због потребе да им се да приступ оперативном систему
на нижем нивоу, вектор напада се повећава. Чак и када ове митигације постојале и
биле у употреби, нападом A1.1.3 се оне могу заобићи.
